...
export const ResumePersonalizationProvider = ({ children }: any) => {
    ...
    return (
        <ResumePersonalizationContext.Provider value={{ userPersonalization, setUserPersonalization }}>
            {children}
        </ResumePersonalizationContext.Provider>
    )
};

export const useResumePersonalizationContext = () => useContext(ResumePersonalizationContext);